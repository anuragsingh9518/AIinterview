    ...
    <motion.div
     initial={{opacity:0}}
        ...
        to-green-100 p-12 flex flex-col justify-center' >
                ...
                <p className="text-gray-600 mb-10">Practice real learing with Ai.
                  develope your interview skills,technical skills and confidence
                </p>
                        ...
                        className='p-12 bg-white'>
                            ...
                            <div className=' space-y-6'>
                              <div className='relative'>
                                ...
                                className='w-full pl-12 pr-4 py-3 border-gray-200 
                                ...
                                <input type="text" placeholder='Enter experience (eg: 2 years) ' 
                                className='w-full pl-12 pr-4 py-3 border-gray-200 
                                rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'
                              ...
                              className='w-full  px-4 py-3 border  border-gray-200 
                                ...
                                {!analysisDone && (
                                 ...
                                 p-8 text-center cursor-pointer hover:border-green-500 hover:bg-gray-50 transition '>
                                  ...
                                  {resumeFile && ( 
                                     ...
                                     className= 'mt-4 bg-gray-900 text-white px-5 py-2 rounded-lg hover:bg-gray-800 transiton'>
                                ...
                                whileHover={{scale:1.03}}
                                whileTap={{scale:0.95}}
                                className='w-full disabled:bg-gray-600 bg-green-600 hover:bg-green-800
