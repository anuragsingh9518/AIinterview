...
const Step3Report = ({ report }) => {
  ...
  let shortTagline = "";
  if (finalScore >= 8) {
    performanceText = "Ready for job opportunites",
      shortTagline = "Excellent performance,Exellent clarity and structured responese"
  } else if (finalScore >= 5) {
    performanceText = "good perfomance,need to improve in some areas"
    shortTagline = "good  foundation ,improve articulation"
  } else {
    performanceText = "Needs significant improvement"
    shortTagline = "Focus on core concepts and communication"
  }
...
//..........................finalScore box...........................................//
  ...
  doc.setFillColor(249,250,251);
    ...
    if(finalScore>=8){
      advice ="Keep it up! You have great communication skills and confidence. Continue practicing to maintain this level."
    }else if(finalScore>=6){
      advice ="Good effort! Focus on improving clarity and technical depth to enhance your performance."
    }else{
      advice ="Significant improvement needed. Work on core concepts and presentation skills to build confidence."
    }
    ...
    sm:px-6 lg:px-10 py-8'>
        ...
        <div className="mb-10 w-full flex items-start gap-4 ">
          <button
            ...
            className=" mt-1 p-3 rounded-full bg-white shadow hover:shadow-md
                            transition"><FaArrowLeft className="text-gray-600" />
          </button>
          <div>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        <div className=' space-y-6 sm:space-y-8'>
          ...
          sm:p-8 '
          >
            <h3 className='text-gray-700 font-semibold text-base  mb-6 sm:text-lg'>Skill Evaluation</h3>
              ...
              {questionWiseScore.map((q, i) =>(
                ...
                sm:rounded-2xl border border-gray-200 '>
                  ...
                  sm:items-start gap-3 mb-4'>
                    <div>
                      <p className='text-xs text-gray-400'>Questions {i+1}</p>
                    ...
                    rounded-full text-xs sm:text-sm w-fit'>
                      {q.score??0}/10
                    </div>
                  </div>
